                    ...
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5" style="text-align: center">
                            ...
                            <form class="mt-5 mb-5 login-input" id="singerSignUpForm" action="${pageContext.request.contextPath}/submitSingerSignUp" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <select id="genre1" name="genre1" form="singerSignUpForm" class="form-control">
                                            <option selected="selected">* Genre1(필수)</option>
                                            <option>Balad</option>
                                            <option>Jazz</option>
                                    ...
                                    <div class="col-md-6">
                                        <select id="genre2" name="genre2" form="singerSignUpForm" class="form-control">
                                            <option selected="selected">* Genre2(필수)</option>
                                            <option>신나는</option>
                                            <option>울적한</option>
                                            <option>잔잔한</option>
                                        </select>
