                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5" style="text-align: center">
                            ...
                            <form class="mt-5 mb-5 login-input" action="${pageContext.request.contextPath}/submitSignUp" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" placeholder="아이디" id="userId" name="userId">
                                    </div>
                                    <button type="button" class="btn mb-1 btn-rounded btn-outline-primary" name="checkIDbtn" id="checkIDbtn">중복확인</button>
                                </div>
                                ...
                                <br>
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control col-sm-5" placeholder="사용자 이름">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nickname" name="nickname" placeholder="닉네임"></div>
