    ...
    public class VideoService {
        ...
        public VideoDto uploadVideo(String title, String content, String genre1, String genre2,
            ...
            try{
                ...
                videoFile.transferTo(new File("//Users/chlee140/workspace/study/practice/MuJam/build/resources/main/static/upload/video/"+uploadVideoName));
                thumbnailFile.transferTo(new File("//Users/chlee140/workspace/study/practice/MuJam/build/resources/main/static/upload/thumbnail/"+uploadThumbnailName));
